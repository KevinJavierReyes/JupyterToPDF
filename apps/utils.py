...
class PDFExporter(Exporter):
    ...
    def set__outputFileName(self, outputName):
    ...
    def from_notebook_node(self, notebook, resources=None, **kwargs):
        ...
        #with os.path.dirname(os.path.realpath(__file__))  as name:
        pdf_fname = os.path.join(os.path.dirname(os.path.realpath(__file__)), self.outputName + ".pdf")
        pdf_fname2 = os.path.join(os.path.dirname(os.path.realpath(__file__)), self.outputName + "-with-attachment" + ".pdf")
